...
type Order struct {
	...
	UniversalTestID              string    `astm:"4"`  // 8.4.5
	Priority                     string    `astm:"5"`  // 8.4.6
	RequestedOrderDateTime       time.Time `astm:"6"`  // 8.4.7
	SpecimenCollectionDateTime   time.Time `astm:"7"`  // 8.4.8
	CollectionEndTime            time.Time `astm:"8"`  // 8.4.9
	...
	DateTimeResultsReported      time.Time `astm:"22"` // 8.4.23
...
type Result struct {
	...
	DateOfChangeInInstrumentNormativeTesting time.Time `astm:"9"`  // 9.10
	OperatorIdentification                   []string  `astm:"10"` // 9.11
	DateTimeTestStarted                      time.Time `astm:"11"` // 9.12
	DateTimeCompleted                        time.Time `astm:"12"` // 9.13
